  ...
  return (
    <div id="customOffers" className="w-full mt-24 h-[573px] p-10 flex flex-col items-center">
      <div className="flex justify-self-strat w-full">
        <p className="text-white lg:text-[48px] md:text-[32px] text-[24px] font-[600] text-center w-full">
          عروض وكوبونات خاصة بمناسبة اليوم الوطني الـــ94
        </p>
        <div className="lg:flex hidden h-20 justify-self-start items-center text-nowrap text-white text-[20px] font-[700] underline-offset-1">
          عرض الكل
        </div>
      </div>
...
// Wrap CustomOffers with React.memo
export default React.memo(CustomOffers);
