...
function Hero() {
  return (
    <div className='relative'>
        <Image priority={true} layout="intrinsic" src='/Group 33974.png' alt='Group 33974.png' width={1264} height={475} className='w-[90vw] min-w-[400px] min-w-[500px] h-auto'></Image>
